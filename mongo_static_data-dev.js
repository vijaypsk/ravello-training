...
var trainerUser = {
    _id: ObjectId('aaaaaaaaaaaaaaaaaaaabbbb'),
    firstName : "Trainer",
    surname : "",
    username : "trainer",
    password : "$2a$10$sYPGeB3jT5teA6s1jPr3UOUZFq3JVxo5F5A/ZZaHJG7Yi2TuLtkM2",
...
var galStudent = {  
    ...
    ravelloCredentials : {
        _id : ObjectId('cdcdcdcdcdcdcdcdcdcd1111'),
    ...
    apps : [  
        {   
            _id : ObjectId('aaaaaaaaaaaaaaaaaaaa1111'),
            ravelloId : "42434767" 
        } 
    ] 
}
...
var danielStudent  = {
    ...
    ravelloCredentials: {
        _id : ObjectId('cdcdcdcdcdcdcdcdcdcd2222'),
        useClassCredentials: false,
        username: 'daniel.wolf@ravellosystems.com',
        password: '!Q@W3e4r'
    },
...
var hadasStudent = {
    ...
    ravelloCredentials: {
        _id : ObjectId('cdcdcdcdcdcdcdcdcdcd3333'),
        useClassCredentials: false,
        username: 'daniel.wolf@ravellosystems.com',
        password: '!Q@W3e4r'
    },
...
var student1Student = {
    ...
    ravelloCredentials : {
        _id : ObjectId('cdcdcdcdcdcdcdcdcdcd4444'),
        useClassCredentials : false,
        username : "gshavit@checkpoint.com",
        password : "M1nnes0ta2014"
    },
    apps : [
        {
            _id : ObjectId('aaaaaaaaaaaaaaaaaaaa4444'),
            ravelloId : "42434796"
        }
    ]
}
...
var class01 = {
    _id: ObjectId('cacacacacacacacacaca1111'),
    name: 'class 01',
    courseId: 'cccccccccccccccccccc1111',
